...
pub trait DequantizeLayerTrait: crate::dnn::DequantizeLayerTraitConst + crate::dnn::LayerTrait {
	...
	fn set_scales(&mut self, mut val: core::Vector<f32>) {
		let ret = unsafe { sys::cv_dnn_DequantizeLayer_setPropScales_vector_float_(self.as_raw_mut_DequantizeLayer(), val.as_raw_mut_VectorOff32()) };
		ret
	}
	
	#[inline]
	fn set_zeropoints(&mut self, mut val: core::Vector<i32>) {
		let ret = unsafe { sys::cv_dnn_DequantizeLayer_setPropZeropoints_vector_int_(self.as_raw_mut_DequantizeLayer(), val.as_raw_mut_VectorOfi32()) };
		ret
	}
...
pub trait QuantizeLayerTrait: crate::dnn::LayerTrait + crate::dnn::QuantizeLayerTraitConst {
	...
	#[inline]
	fn set_scales(&mut self, mut val: core::Vector<f32>) {
		let ret = unsafe { sys::cv_dnn_QuantizeLayer_setPropScales_vector_float_(self.as_raw_mut_QuantizeLayer(), val.as_raw_mut_VectorOff32()) };
		ret
	}
	
	#[inline]
	fn set_zeropoints(&mut self, mut val: core::Vector<i32>) {
		let ret = unsafe { sys::cv_dnn_QuantizeLayer_setPropZeropoints_vector_int_(self.as_raw_mut_QuantizeLayer(), val.as_raw_mut_VectorOfi32()) };
		ret
	}
...
pub trait ReduceLayerTrait: crate::dnn::LayerTrait + crate::dnn::ReduceLayerTraitConst {
	...
	fn set_target_dims(&mut self, mut val: core::Vector<size_t>) {
		let ret = unsafe { sys::cv_dnn_ReduceLayer_setPropTargetDims_vector_size_t_(self.as_raw_mut_ReduceLayer(), val.as_raw_mut_VectorOfsize_t()) };
		ret
	}
