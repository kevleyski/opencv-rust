...
/// 
/// The function implements the Optimal Triangulation Method (see Multiple View Geometry [HartleyZ00](https://docs.opencv.org/4.6.0/d0/de3/citelist.html#CITEREF_HartleyZ00) for details).
...
/// the homography matrix H is described in detail in [Malis2007](https://docs.opencv.org/4.6.0/d0/de3/citelist.html#CITEREF_Malis2007).
/// 
...
/// information as described in [Malis2007](https://docs.opencv.org/4.6.0/d0/de3/citelist.html#CITEREF_Malis2007) . The summary of the method: the #decomposeHomographyMat function
